...
func generateSitaClientProfile(longTerm *gotrax.Keypair, forgingKey *gotrax.Keypair) *gotrax.ClientProfile {
...
func generateSitaTestData() *testData {
	...
	t.forgingKey = gotrax.DeriveKeypair([symKeyLength]byte{0x55, 0x00, 0x00, 0x22, 0x33, 0x00, 0x00, 0x44})
	t.forgingKey.Pub = gotrax.CreatePublicKey(t.forgingKey.Pub.K(), gotrax.ForgingKey)
...
func (s *GenericServerSuite) Test_flow_CheckStorageNumber(c *C) {
	...
	c.Assert(d2.sigma.C2.Encode(), DeepEquals, []byte{
		0xa5, 0xe1, 0xc2, 0xc9, 0xd3, 0x68, 0x7e, 0x6b,
		0xcc, 0xfb, 0x51, 0xa4, 0xd3, 0xfb, 0xd8, 0xcf,
		0xe6, 0xcb, 0x8f, 0x62, 0xca, 0x98, 0xb7, 0xbf,
		0xff, 0x21, 0x88, 0x94, 0xe0, 0x55, 0x71, 0xa4,
		0xfe, 0x7d, 0x26, 0x3c, 0x20, 0x50, 0xf2, 0xec,
		0x12, 0x2d, 0x73, 0x63, 0xbb, 0x6a, 0xfa, 0x40,
		0x73, 0xc6, 0x8d, 0xc4, 0xcd, 0x2c, 0xbb, 0x3a,
	})

	c.Assert(d2.sigma.R2.Encode(), DeepEquals, []byte{
		0x4f, 0xfb, 0x22, 0x9e, 0x29, 0xe0, 0xd, 0xc,
		0x77, 0x15, 0x63, 0x52, 0x10, 0x7f, 0x7c, 0x62,
		0xa5, 0x4e, 0x3d, 0x66, 0x55, 0x4, 0x88, 0x3f,
		0x84, 0xe1, 0x6c, 0xb1, 0x21, 0xd, 0xa6, 0x73,
		0x65, 0x50, 0xd5, 0x59, 0x7d, 0xf1, 0x53, 0x91,
		0xf8, 0xcb, 0x40, 0x71, 0xbc, 0x6b, 0x38, 0x2,
		0x23, 0xc6, 0x6c, 0x7d, 0x21, 0x5, 0x84, 0x1c,
	})
