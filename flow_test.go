...
func generateSitaClientProfile(longTerm *keypair) *clientProfile {
	...
	sita.sig = &eddsaSignature{s: [114]byte{
		0x97, 0xc3, 0xc9, 0x20, 0x32, 0xb9, 0x6a, 0x2e,
		0x98, 0x46, 0xc7, 0x6e, 0x19, 0x9d, 0x30, 0x8e,
		0xa5, 0x1a, 0x18, 0x4d, 0xda, 0x77, 0x4b, 0x89,
		0xcc, 0x40, 0x41, 0x8f, 0x6b, 0x6c, 0x2, 0xc9,
		0x4d, 0xbf, 0xdb, 0x76, 0x66, 0xa0, 0xa5, 0x11,
		0x96, 0xc6, 0xff, 0x38, 0xab, 0x6e, 0x4a, 0x8b,
		0xb0, 0xbb, 0x21, 0x12, 0x45, 0xd4, 0xf, 0x2a,
		0x80, 0x6d, 0x22, 0x57, 0x39, 0xcc, 0xdf, 0x44,
		0x67, 0x75, 0xa2, 0xb, 0xd, 0x6d, 0xfc, 0x7e,
		0x2b, 0x89, 0x17, 0xaa, 0x4c, 0x61, 0xa0, 0x61,
		0xf7, 0x3d, 0xee, 0x3e, 0x29, 0xee, 0xe7, 0x28,
		0xbb, 0x2a, 0x6f, 0x5f, 0x5d, 0x9e, 0xac, 0xf4,
		0x25, 0x78, 0xa6, 0x1a, 0x24, 0x6e, 0x10, 0xb,
		0x59, 0xfc, 0x4, 0xf8, 0xcb, 0xbb, 0xb4, 0x3f,
		0x32, 0x0,
	}}
	return sita
}
...
func (s *GenericServerSuite) Test_flow_CheckStorageNumber(c *C) {
	...
	c.Assert(d2.sigma.c2.Encode(), DeepEquals, []byte{
		0x58, 0x18, 0x88, 0x41, 0x25, 0x41, 0x46, 0xb5,
		0xc2, 0xab, 0x5, 0x33, 0x3, 0x60, 0x67, 0x97,
		0x61, 0x44, 0x9e, 0x7d, 0x36, 0x4b, 0x35, 0x56,
		0xe2, 0x58, 0xd5, 0xc, 0xad, 0x4b, 0x96, 0x4b,
		0xa2, 0xc6, 0x4f, 0xce, 0x8c, 0xfa, 0x2e, 0x2a,
		0x1f, 0xcc, 0xf3, 0x6c, 0x12, 0xad, 0x4f, 0x2a,
		0xe4, 0xc5, 0xe, 0xce, 0xff, 0x49, 0x93, 0x32,
	})

	c.Assert(d2.sigma.r2.Encode(), DeepEquals, []byte{
		0xd, 0x40, 0xd6, 0xef, 0xd2, 0xb6, 0xf, 0x77,
		0x43, 0xce, 0x96, 0xaf, 0x1f, 0x30, 0xd0, 0xc9,
		0x4e, 0x4b, 0x4e, 0x29, 0x3a, 0xcf, 0x10, 0xdd,
		0x8d, 0xa7, 0x1a, 0xb4, 0x21, 0x20, 0xb1, 0x2d,
		0x8d, 0x2f, 0x17, 0x60, 0x6c, 0x64, 0xae, 0x41,
		0x28, 0x2e, 0x52, 0x70, 0x8b, 0x3f, 0x8, 0xc,
		0x2d, 0xa9, 0x80, 0xda, 0x20, 0x26, 0x2, 0x15,
	})
