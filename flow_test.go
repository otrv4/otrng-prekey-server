...
func (s *GenericServerSuite) Test_flow_CheckStorageNumber(c *C) {
	...
	c.Assert(d2.sigma.c2.Encode(), DeepEquals, []byte{
		0x79, 0x8a, 0xc6, 0x1a, 0x99, 0x76, 0x38, 0x2d,
		0x8f, 0x26, 0xf8, 0xc3, 0xc2, 0x17, 0x52, 0x96,
		0xb9, 0x84, 0xaa, 0x4f, 0x90, 0x5, 0xe3, 0x48,
		0x29, 0xaa, 0x6d, 0x71, 0x83, 0xa6, 0x18, 0xfe,
		0xbc, 0xdb, 0x25, 0xb7, 0x27, 0xca, 0xdf, 0x46,
		0x9d, 0xb2, 0xff, 0x27, 0x29, 0xe3, 0xe3, 0xe8,
		0x8c, 0x9, 0xaf, 0xe1, 0x8d, 0xdb, 0x14, 0xa,
	})

	c.Assert(d2.sigma.r2.Encode(), DeepEquals, []byte{
		0x69, 0x6f, 0xd8, 0x1a, 0x14, 0x76, 0xa3, 0x5e,
		0x15, 0xfc, 0xb6, 0x9e, 0x3d, 0x20, 0x4e, 0x4d,
		0xd4, 0xc1, 0x7f, 0xa9, 0xbf, 0x57, 0x82, 0x29,
		0x3a, 0x77, 0xc6, 0xdf, 0xad, 0x4e, 0xaa, 0x67,
		0xa2, 0x48, 0x23, 0xbf, 0x9c, 0x7e, 0x63, 0x64,
		0x65, 0x6c, 0x40, 0x1a, 0x98, 0x5f, 0x71, 0x9d,
		0x5e, 0x4, 0x8c, 0xa5, 0xa4, 0x39, 0x63, 0x10,
	})
