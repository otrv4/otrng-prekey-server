...
func (s *GenericServerSuite) Test_flow_CheckStorageNumber(c *C) {
	...
	c.Assert(d2.serverFingerprint[:], DeepEquals, []byte{
		0xd7, 0x44, 0xd, 0xc6, 0xf9, 0xde, 0x52, 0x48,
		0x81, 0xf9, 0x3b, 0x61, 0x4b, 0x6a, 0xe8, 0x5d,
		0x1c, 0x87, 0xa1, 0xe6, 0xc2, 0x6a, 0xfc, 0xb,
		0x5d, 0xf6, 0xf8, 0xfc, 0x33, 0x8c, 0xe2, 0x7,
		0x9d, 0x3c, 0x4f, 0x92, 0x21, 0x5c, 0xe2, 0xd4,
		0x4c, 0xbc, 0x5e, 0x8a, 0x62, 0x6a, 0xc4, 0x4a,
		0x5d, 0x81, 0x73, 0xb0, 0x31, 0x85, 0x4d, 0x3f,
	})
	...
	c.Assert(d2.sigma.c2.Encode(), DeepEquals, []byte{
		0x14, 0xb0, 0x21, 0x42, 0xe9, 0x71, 0xa7, 0x29,
		0x7, 0xf8, 0x34, 0x5f, 0x4a, 0x67, 0xf, 0x74,
		0xe6, 0xae, 0xc3, 0x3e, 0xeb, 0xe0, 0x3e, 0xe1,
		0x69, 0x8b, 0x96, 0x7c, 0x87, 0x31, 0x58, 0xee,
		0x68, 0xa9, 0x77, 0xbc, 0x89, 0x88, 0xd7, 0xbd,
		0x8, 0x24, 0xa3, 0x26, 0xb, 0x90, 0xc7, 0xa9,
		0xee, 0xc2, 0x45, 0x22, 0xbb, 0xf4, 0x8e, 0x3e,
	})

	c.Assert(d2.sigma.r2.Encode(), DeepEquals, []byte{
		0xe7, 0x17, 0x6d, 0xcb, 0x1c, 0xb, 0x61, 0xf4,
		0x3c, 0xa8, 0x3a, 0x23, 0x94, 0x20, 0x5b, 0x28,
		0x2a, 0xeb, 0x48, 0x2e, 0x2e, 0x3f, 0xd4, 0xef,
		0x1b, 0x41, 0x92, 0x89, 0x41, 0xb2, 0x43, 0x5,
		0xb1, 0x89, 0xbd, 0xa3, 0x74, 0xa4, 0x91, 0x90,
		0x9a, 0xcf, 0x6, 0x90, 0x24, 0xb9, 0xf2, 0xd7,
		0x72, 0xb3, 0x3a, 0xb4, 0xf7, 0x50, 0x98, 0x13,
	})
