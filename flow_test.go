...
func (s *GenericServerSuite) Test_flow_CheckStorageNumber(c *C) {
	...
	c.Assert(d2.sigma.c2.Encode(), DeepEquals, []byte{
		0x97, 0x28, 0x89, 0x17, 0x4d, 0x2a, 0x1b, 0x99,
		0x6, 0x3e, 0x9f, 0x1b, 0xca, 0x3f, 0xef, 0xbc,
		0x6c, 0x3d, 0x91, 0x28, 0x71, 0xd6, 0x8f, 0x24,
		0xe3, 0x54, 0x87, 0x1e, 0x6c, 0xfd, 0xa4, 0xd1,
		0x1b, 0xd5, 0x68, 0x47, 0xcd, 0x49, 0xdf, 0xfd,
		0x8e, 0xa5, 0x69, 0x6b, 0x50, 0xb2, 0x7d, 0xcd,
		0x9b, 0xa6, 0x2c, 0xbc, 0x19, 0x97, 0x9b, 0x2b,
	})

	c.Assert(d2.sigma.r2.Encode(), DeepEquals, []byte{
		0x1e, 0xd6, 0x11, 0x71, 0xa8, 0x3f, 0x1, 0x29,
		0x69, 0xe0, 0x20, 0x1c, 0x9a, 0xaf, 0xa2, 0xda,
		0x5e, 0x85, 0x74, 0x15, 0xc4, 0xde, 0xfb, 0xbc,
		0x75, 0x23, 0x8a, 0xab, 0xe9, 0x3e, 0xb, 0x99,
		0xf8, 0x5c, 0x6f, 0x7f, 0x1f, 0x32, 0xf2, 0x1f,
		0xfc, 0x84, 0xf3, 0x8, 0x84, 0xdb, 0xeb, 0x19,
		0x8d, 0xde, 0x9b, 0xef, 0x5f, 0xeb, 0x33, 0x16,
	})
