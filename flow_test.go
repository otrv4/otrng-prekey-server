...
func generateSitaClientProfile(longTerm *keypair) *clientProfile {
	...
	sita.sig = &eddsaSignature{s: [114]byte{
		0x98, 0xb8, 0x29, 0xc, 0x33, 0xc0, 0xed, 0xe3,
		0x8d, 0xfe, 0x6f, 0xcd, 0xbd, 0x8c, 0x35, 0x97,
		0x1, 0xf2, 0xca, 0x50, 0x7b, 0x20, 0xb6, 0x54,
		0x90, 0xef, 0x87, 0x26, 0xb0, 0xca, 0x7, 0x9e,
		0xf6, 0xbb, 0x1b, 0xc7, 0x23, 0x18, 0x9f, 0x29,
		0x1c, 0xd, 0xdb, 0xa7, 0x73, 0x99, 0xeb, 0x34,
		0x98, 0x4d, 0x57, 0xb0, 0x28, 0xdc, 0x13, 0x2b,
		0x0, 0x7c, 0xea, 0xf2, 0x4c, 0xdc, 0x87, 0x2d,
		0x41, 0x2d, 0x9a, 0xf8, 0xef, 0xde, 0xaf, 0x18,
		0x7c, 0xcf, 0x1, 0x93, 0xad, 0x17, 0x82, 0x83,
		0x7c, 0xee, 0x84, 0x2f, 0x2a, 0x1c, 0xe8, 0xa0,
		0xca, 0x26, 0x66, 0xcc, 0x4, 0xef, 0x5d, 0x37,
		0xcf, 0x84, 0x8e, 0xf1, 0x8f, 0xf, 0xff, 0xdb,
		0x28, 0xb9, 0x14, 0xac, 0xa0, 0x1d, 0x0, 0x84,
		0x39, 0x0,
	}}
	return sita
}
...
func (s *GenericServerSuite) Test_flow_CheckStorageNumber(c *C) {
	...
	c.Assert(d2.sigma.c2.Encode(), DeepEquals, []byte{
		0x81, 0xfe, 0x68, 0x26, 0x62, 0x68, 0xd2, 0x4b,
		0x49, 0x83, 0x9c, 0x81, 0xe6, 0x1, 0x1d, 0x27,
		0xb6, 0x18, 0x90, 0x1b, 0xc6, 0x33, 0x40, 0x8f,
		0xbb, 0xdb, 0x66, 0xc8, 0xb7, 0x3b, 0xb9, 0x3,
		0x49, 0xcd, 0x24, 0xe4, 0x9c, 0x56, 0xef, 0x63,
		0x12, 0xac, 0xd9, 0xeb, 0x67, 0x2, 0x54, 0xaa,
		0x97, 0x5f, 0x5e, 0xf0, 0xbe, 0xe1, 0x29, 0x2e,
	})

	c.Assert(d2.sigma.r2.Encode(), DeepEquals, []byte{
		0x17, 0x10, 0x30, 0x7, 0x96, 0x1a, 0x24, 0x3e,
		0x5, 0xe0, 0xbc, 0xe2, 0x55, 0xa0, 0x25, 0x99,
		0x75, 0x24, 0x5a, 0xb6, 0xf0, 0xdb, 0xed, 0x45,
		0x3e, 0x6e, 0x4b, 0x43, 0xd8, 0xad, 0xee, 0xd8,
		0xc6, 0x64, 0xca, 0xdb, 0x8, 0x86, 0x6a, 0xb9,
		0x6e, 0x1c, 0xec, 0x1, 0x48, 0xe5, 0x84, 0xe7,
		0x2d, 0x5, 0x96, 0x97, 0xf4, 0x9a, 0xa0, 0x32,
	})
