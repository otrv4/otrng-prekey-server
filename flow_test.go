...
func (s *GenericServerSuite) Test_flow_CheckStorageNumber(c *C) {
	...
	c.Assert(d2.sigma.c2.Encode(), DeepEquals, []byte{
		0x8d, 0x33, 0xe3, 0xf3, 0x11, 0x11, 0x2d, 0x18,
		0x43, 0x1d, 0xae, 0x35, 0xd6, 0xe9, 0x77, 0x81,
		0x7b, 0x9, 0xe1, 0x40, 0x75, 0x40, 0xef, 0xd0,
		0xd3, 0x39, 0x6a, 0xd, 0xd7, 0xa4, 0x65, 0x18,
		0xfe, 0x70, 0xfc, 0xd1, 0x98, 0xb3, 0x68, 0x70,
		0xee, 0x18, 0x2f, 0x19, 0xae, 0x43, 0x75, 0xcf,
		0x22, 0xf3, 0x5f, 0xc9, 0x24, 0xcc, 0x6e, 0x7,
	})

	c.Assert(d2.sigma.r2.Encode(), DeepEquals, []byte{
		0x78, 0x88, 0xc7, 0xf7, 0x20, 0xb2, 0xe4, 0x32,
		0xb1, 0xac, 0x65, 0x12, 0x31, 0x62, 0x99, 0xe5,
		0x78, 0xf6, 0xe3, 0x49, 0x6b, 0x6e, 0x68, 0xd,
		0x71, 0xfe, 0x2f, 0x45, 0x2c, 0x2c, 0x48, 0x2b,
		0xae, 0xbd, 0xc5, 0xf6, 0x7, 0x77, 0x32, 0xf6,
		0x5d, 0x6d, 0xf2, 0xd2, 0x10, 0xa3, 0x45, 0x8a,
		0xa9, 0x59, 0x1c, 0x72, 0xca, 0xd3, 0xfe, 0x9,
	})
